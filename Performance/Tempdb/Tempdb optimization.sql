...
select @sqlmemory=convert(int,(physical_memory_kb/1024)) from sys.dm_os_sys_info;
...
--  members of sysadmin.
-------------------------------------------------------------
--Enable show advanced options at server level
sp_configure 'show advanced options', 1;
GO
RECONFIGURE
GO
--Enable Database mail configuration wizard
...
EXECUTE msdb.dbo.sysmail_add_profile_sp
       ...
       @description = 'Profile for sending outgoing notifications using PIMCO STMP Mail'
GO
...
EXECUTE msdb.dbo.sysmail_add_account_sp
    @account_name = 'PimcoMail',
    @description = 'Account for outgoing notifications',
    @email_address = 'dba_team@de.pimco.com',
    @display_name = 'SQLServer',
	@port = 25,
    @mailserver_name = 'Mailhost.pimco.com'
GO
...
--Send test mail 
	EXEC msdb.dbo.sp_send_dbmail
        @profile_name = 'Notifications',
        @recipients = 'Technology-ServicesDBA@pimco.com',
        @body = "Database Mail created",
        @subject = '[Info]:SQLServer DB Mail Created';
...
EXEC dbo.sp_add_operator
    ...
    @pager_address = N'Technology-ServicesDBA@pimco.com',
...
USE [DBA_Utility] -- Specify the database in which the objects will be created.
...
SET @BackupDirectory     = N'\\nasclusdev\pmsqlbackup5\Solarwinds\' -- Specify the backup root directory.
