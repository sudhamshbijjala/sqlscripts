...
SET @BackupFile = 'Z:\Temp\SEL_201004190530.BAK'
...
MOVE 'SEL_Data' TO 'j:\SQL\DATA\SQL_Data.mdf',
MOVE 'SEL_Data_01' TO 'j:\sql\data\SEL_Data_01.ndf',
MOVE 'SEL_Log' TO 'l:\SQL\LOG\SQL_Log.ldf';